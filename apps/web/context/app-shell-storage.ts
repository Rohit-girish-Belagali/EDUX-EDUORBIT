...
export const ACTIVE_SESSION_STORAGE_KEY = "edux.activeSessionId.tab";
export const LANGUAGE_STORAGE_KEY = "edux-language";
export const SIDEBAR_COLLAPSED_STORAGE_KEY = "edux.sidebarCollapsed";
export const CHAT_RESPONSE_TIMEOUT_STORAGE_KEY =
  "edux.chatResponseTimeout";
...
export const ACTIVE_SESSION_EVENT = "edux:active-session";
export const LANGUAGE_EVENT = "edux:language";
export const SIDEBAR_COLLAPSED_EVENT = "edux:sidebar-collapsed";
