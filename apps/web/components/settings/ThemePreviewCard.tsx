...
const PALETTES: Record<Theme, Palette> = {
  ...
  // theme id "neon" applies .dark + .theme-neon → futuristic near-black
  // blue-green canvas with a bright cyan accent (the default theme)
  neon: {
    bg: "#0a0f14",
    fg: "#e2eef2",
    card: "#101820",
...
// Renders a miniature EDUX UI mockup in the given theme's palette —
