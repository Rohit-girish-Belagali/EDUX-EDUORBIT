...
import { fetchAllPlans } from "@/lib/timetable-api";
...
const GROUPS: DashboardGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        key: "timetable_planner",
        href: "/space/timetable",
        icon: CalendarClock,
        title: { zh: "时间表规划", en: "Timetable Planner" },
        blurb: {
          zh: "上传大纲，自动生成每日学习、练习与复习安排。",
          en: "Upload a syllabus and get a day-by-day learn/practice/revision plan.",
        },
        unit: { zh: "个计划", en: "plans" },
        tile: "bg-cyan-500/10 text-cyan-600 dark:text-cyan-400",
        load: async () => (await fetchAllPlans()).length,
      },
      {
        key: "personas",
        href: "/space/personas",
