...
const SESSION_KEY_PREFIX = "edux.voiceAutoplay.session"; // "on" | "off"
const PROMPTED_KEY_PREFIX = "edux.voiceAutoplay.prompted"; // "1"
const GLOBAL_EVENT = "edux:voice-autoplay-global";
const SESSION_EVENT = "edux:voice-autoplay-session";
