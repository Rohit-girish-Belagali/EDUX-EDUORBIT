 ...
 * `EDUX_API_BASE_URL` (exported by the container entrypoint from
...
/**
 * Parse a "EDUX_AUTH_ENABLED"-style flag at runtime.
 *
...
// The browser bundle never sees `EDUX_AUTH_ENABLED` (it isn't a
