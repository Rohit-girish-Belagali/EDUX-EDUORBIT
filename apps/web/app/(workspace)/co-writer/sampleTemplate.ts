...
export const CO_WRITER_SAMPLE_TEMPLATE = `# EDUX Co-Writer

> EDUX's built-in writing canvas for notes, reports, tutorials, and AI-assisted drafts.
...
- A practical starter draft for EDUX product docs and learning content
...
The <abbr title="Large Language Model">LLM</abbr> layer powers EDUX while the <abbr title="Retrieval Augmented Generation">RAG</abbr> layer provides grounded knowledge support.

### Blockquotes

> EDUX helps students turn questions into structured understanding.
>
> "Learn deeply, write clearly.", [EDUX](#edux-co-writer)

### Links

[EDUX Co-Writer](#edux-co-writer "co-writer section")

[EDUX Learning Note](#edux-learning-note)

[EDUX Website](https://eduorbit.com)

[Reference link][edux-doc]

[edux-doc]: #edux-learning-note

### Code Blocks

#### Inline code

\`edux chat --once "Summarize this section"\`
...
> EDUX brand mark used inside the co-writer template.
...
op=>operation: EDUX analyzes intent
...
${FENCE}seq
Student->EDUX: Ask for help
EDUX->KnowledgeBase: Load context
Note right of EDUX: Collect memory\\nand relevant knowledge
EDUX-->Student: Return guided response
Student->>EDUX: Request rewrite in co-writer
${FENCE}
