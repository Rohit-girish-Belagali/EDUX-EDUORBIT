...
export default function AppearanceSettingsPage() {
  ...
  return (
    <div data-tour="tour-appearance">
      ...
      >
        <div className="py-4">
          {/* Order is intentional: Neon (futuristic dark cyan, the default
              selection) → pure-white Default (theme id "snow" kept for
              stored preferences) → warm-light Cream → warm-dark Dark →
              cool-dark Glass. */}
          ...
          <p className="mt-4 text-[11.5px] leading-relaxed text-[var(--muted-foreground)]/80">
            {t(
              "Neon is a futuristic dark theme with a cyan accent. Default is a clean pure-white theme with a blue accent. Cream is warm and paper-like with a terracotta accent. Dark keeps Cream's warmth on near-black. Glass adds translucent purple panels on a deep gradient.",
            )}
          </p>
        </div>
      </SettingSection>
