...
const PIP_HINT: Record<string, string> = {
  docling: "pip install edux[parse-docling]",
  markitdown: "pip install edux[parse-markitdown]",
  pymupdf4llm: "pip install edux[parse-pymupdf4llm]",
};
  ...
  return (
    ...
    >
      <SettingRow
        ...
        description={t(
          "Reserved — uses EDUX's vision model to caption images during conversion.",
        )}
        control={
          <Toggle
            checked={llmImages}
