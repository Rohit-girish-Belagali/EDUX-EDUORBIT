...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "Docker settings: "
        f"backend={values['EDUX_DOCKER_BACKEND_PORT']} "
        f"frontend={values['EDUX_DOCKER_FRONTEND_PORT']} "
        f"pocketbase={values['EDUX_DOCKER_POCKETBASE_PORT']}",
        file=sys.stderr,
    )
