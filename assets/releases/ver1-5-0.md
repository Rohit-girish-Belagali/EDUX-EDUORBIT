# EDUX v1.5.0 Release Notes

**Release Date:** 2026.07.04

v1.5.0 closes out the entire v1.4 line and opens the next. Rather than a single-point delta, this note looks back across the whole arc from [v1.4.0-beta](past_releases/ver1-4-0-beta.md) to today — the release that turned EDUX into an agent-native, community-driven tutoring platform. Over these weeks the community sent **36 merged pull requests** and helped us **resolve 53 issues**. Thank you — this release is as much yours as ours.
...
- #565 — Question
- #592 — Should EDUX become installable apps?
- #597 — Does a Partner have its own memory?
- #598 — Can non-admin users use and create Partners in multi-user mode?

## Upgrade Notes

Drop-in from any v1.4.x: `pip install -U edux`; Docker users pull `ghcr.io/eduorbit/edux:latest`. No migrations — existing knowledge bases, partners, souls, and mastery paths keep working as-is. Two things to know:
