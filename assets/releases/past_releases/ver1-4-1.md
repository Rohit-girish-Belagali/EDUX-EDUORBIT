...
multimodal image-fallback fix for providers EDUX has no vision entry for.
...
## Upgrade Notes
- Drop-in from v1.4.0: `pip install -U edux`; Docker users pull
...
**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.4.0...v1.4.1
