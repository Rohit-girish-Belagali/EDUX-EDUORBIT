# EDUX v1.4.7 Release Notes

**Release Date:** 2026.06.18

A focused release on top of [v1.4.6](ver1-4-6.md): your local coding agents
become something EDUX can talk to. Connect **Claude Code** or **Codex**
...
> or Codex CLI already installed on the machine running EDUX — nothing is
...
- EDUX detects an installed **Claude Code** or **Codex** and connects it as
...
- Drop-in from v1.4.6: `pip install -U edux`; Docker users pull
  `ghcr.io/eduorbit/edux:latest`. No migrations.
- Connected Agents require the Claude Code and/or Codex CLI installed on the
  host running EDUX — they are detected, never installed for you.
- The docs at [eduorbit.com](https://eduorbit.com/) are still catching up to
  the recent releases and will be refreshed shortly.

**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.4.6...v1.4.7
