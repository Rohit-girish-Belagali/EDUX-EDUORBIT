...
## What's Changed
* fix(UI): unrendered markdown in ActivityDetail card by @tusharkhatriofficial in https://github.com/eduorbit/EDUX/pull/26
* chore: transtale readme to ru by @oshliaer in https://github.com/eduorbit/EDUX/pull/27
* fix: improve reload_excludes configuration for uvicorn server and added support for newer models (openai) by @LouisACR in https://github.com/eduorbit/EDUX/pull/28
* feat: Dynamic LLM Provider Support (Local & Cloud) by @ahmedjawedaj in https://github.com/eduorbit/EDUX/pull/34

## 🤝New Contributors
* @oshliaer made their first contribution in https://github.com/eduorbit/EDUX/pull/27
* @LouisACR made their first contribution in https://github.com/eduorbit/EDUX/pull/28
* @ahmedjawedaj made their first contribution in https://github.com/eduorbit/EDUX/pull/34
