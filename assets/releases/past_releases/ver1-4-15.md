...
Drop-in from v1.4.14: `pip install -U edux`; Docker users pull `ghcr.io/eduorbit/edux:latest`. No migrations and no behavior changes — existing knowledge bases, partners, and mastery paths keep working as-is.

**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.4.14...v1.4.15
