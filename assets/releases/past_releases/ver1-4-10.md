...
### Run EDUX in a container, rootless-ready

A new [CONTAINERIZATION.md](https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/blob/main/CONTAINERIZATION.md)
...
per-request access log is now disabled on **every** launch path (`edux
...
Drop-in from v1.4.9: `pip install -U edux`; Docker users pull
`ghcr.io/eduorbit/edux:latest`. No migrations, no configuration changes.
...
**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.4.9...v1.4.10
