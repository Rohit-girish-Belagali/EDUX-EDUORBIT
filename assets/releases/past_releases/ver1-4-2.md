...
session), and a Docs link to [eduorbit.com](https://eduorbit.com/)
...
- Drop-in from v1.4.1: `pip install -U edux`; Docker users pull
...
**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.4.1...v1.4.2
