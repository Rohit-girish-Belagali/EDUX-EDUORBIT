...
**Removed `edux/core` module** - All functionality migrated to `edux/services`:

| Old Import | New Import |
|:---|:---|
| `from edux.core.core import load_config_with_main` | `from edux.services.config import load_config_with_main` |
| `from edux.core.llm_factory import llm_complete` | `from edux.services.llm import complete` |
| `from edux.core.prompt_manager import get_prompt_manager` | `from edux.services.prompt import get_prompt_manager` |
| `from edux.core.logging import get_logger` | `from edux.logging import get_logger` |
...
**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v0.4.0...v0.4.1
