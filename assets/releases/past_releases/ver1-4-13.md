...
Drop-in from v1.4.12: `pip install -U edux`; Docker users pull `ghcr.io/eduorbit/edux:latest`. No migrations and no behavior changes for existing single-user setups. In multi-user deployments, assigning a partner to a user is a new option in the grant editor — nothing changes until you use it.

**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.4.12...v1.4.13
