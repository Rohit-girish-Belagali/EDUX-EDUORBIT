...
- **Minimal thinking mode is provider-safe** - DeepSeek, DashScope, VolcEngine,
  ...
  `reasoning_effort=minimal`; EDUX sends the provider-specific disable
  signal instead.
...
- **`edux start` launches the full web stack** - the CLI now delegates to
...
- Added CLI coverage so `edux start` propagates the launcher exit code.
...
**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.3.8...v1.3.9
