...
- Set `LLM_REASONING_EFFORT` in `.env` if you need global thinking control.
  Leave it empty to let EDUX auto-detect behavior from the active model.
...
**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.3.6...v1.3.7
