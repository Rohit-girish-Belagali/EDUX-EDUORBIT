...
Embedding configuration is now explicit about the exact URL EDUX will call.
...
- **Settings now shows Endpoint URL for embeddings** - the Web settings page
  labels embedding URLs as endpoint URLs and explains that EDUX posts to
...
**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.3.1...v1.3.2
