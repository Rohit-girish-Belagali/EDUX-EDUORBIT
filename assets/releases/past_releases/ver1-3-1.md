...
- **Selected KB is now trusted system state** - chat RAG calls no longer let the
  LLM invent or override `kb_name`; the model only sees a `query`, and EDUX
...
- **Embedding responses are validated before use** - EDUX now rejects
...
**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.3.0...v1.3.1
