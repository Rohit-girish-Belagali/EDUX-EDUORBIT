...
[eduorbit.com](https://eduorbit.com/) have been rebuilt alongside —
...
[eduorbit.com](https://eduorbit.com/) was rebuilt with this release:
...
- `pip install -U edux` — the migrations run automatically on first
...
**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.4.2...v1.4.3
