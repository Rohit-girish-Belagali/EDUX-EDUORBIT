...
EDUX offloads retrieval to it over HTTP — no local index is built. Each KB
...
`pip install edux[parse-pymupdf4llm]`; engines that need packages can now be
...
Drop-in from v1.4.11: `pip install -U edux`; Docker users pull
`ghcr.io/eduorbit/edux:latest`. No migrations. Existing LlamaIndex knowledge bases
...
**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.4.11...v1.4.12
