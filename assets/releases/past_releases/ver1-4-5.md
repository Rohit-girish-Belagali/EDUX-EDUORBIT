...
A new loop-plugin framework (`edux/loop_plugins/`) lets a feature
...
- Drop-in from v1.4.4: `pip install -U edux`; Docker users pull
  `ghcr.io/eduorbit/edux:latest`. No migrations — existing learning
  progress loads as-is.
- Windows launch scripts moved into `scripts/`: run
  `scripts\start_backend.bat` / `scripts\start_frontend.bat`.

**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.4.4...v1.4.5
