...
- **Embedding examples are easier to follow** - English and Chinese sample env
  files now explain that `EMBEDDING_HOST` is the exact endpoint EDUX calls.
...
**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.3.4...v1.3.5
