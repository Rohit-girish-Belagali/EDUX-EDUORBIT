...
[CONTAINERIZATION.md](https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/blob/main/CONTAINERIZATION.md).
...
Drop-in from v1.4.10: `pip install -U edux`; Docker users pull
`ghcr.io/eduorbit/edux:latest`. No migrations, no configuration changes. The one
...
**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.4.10...v1.4.11
