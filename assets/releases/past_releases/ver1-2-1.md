...
- **CLI** — `/regenerate` (alias `/retry`) inside the `edux chat` REPL.
...
**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.2.0...v1.2.1
