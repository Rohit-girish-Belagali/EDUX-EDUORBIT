...
When EDUX grades a question inside a Mastery Path, the attempt — the
...
Drop-in from v1.4.8: `pip install -U edux`; Docker users pull
`ghcr.io/eduorbit/edux:latest`. No migrations, no configuration changes.

**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.4.8...v1.4.9
