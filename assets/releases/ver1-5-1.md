...
Drop-in from v1.5.0: `pip install -U edux`; Docker users pull `ghcr.io/eduorbit/edux:latest`. No migrations and no behavior changes — existing knowledge bases, partners, and mastery paths keep working as-is. Connected (read-only) and legacy knowledge bases still reject per-file deletion, as before.

**Full Changelog**: https://github.com/Rohit-girish-Belagali/EDUX-EDUORBIT/compare/v1.5.0...v1.5.1
