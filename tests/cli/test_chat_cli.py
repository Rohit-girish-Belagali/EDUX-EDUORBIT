"""CLI smoke tests for the standalone ``edux-cli`` package."""
...
def _install_fake_runtime(monkeypatch, captured_requests: list[TurnRequest]) -> None:
    ...
    monkeypatch.setattr("edux.app.facade.EDUXApp.start_turn", _start_turn)
    monkeypatch.setattr("edux.app.facade.EDUXApp.stream_turn", _stream_turn)
...
def test_session_list_command_uses_shared_store(monkeypatch) -> None:
    ...
    monkeypatch.setattr("edux.app.facade.EDUXApp.list_sessions", _list_sessions)
...
def test_start_command_delegates_to_runtime_launcher(monkeypatch) -> None:
    ...
    monkeypatch.setattr("edux.runtime.launcher.start", _fake_start)
