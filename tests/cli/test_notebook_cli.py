"""CLI smoke tests for ``edux notebook`` commands."""
...
def _patch_facade(monkeypatch) -> None:
    """Patch EDUXApp methods to use the shared fake manager."""
    ...
    from edux.app import facade

    monkeypatch.setattr(facade.EDUXApp, "create_notebook", _create_notebook)
    monkeypatch.setattr(facade.EDUXApp, "get_notebook", _get_notebook)
    monkeypatch.setattr(facade.EDUXApp, "add_record", _add_record)
    monkeypatch.setattr(facade.EDUXApp, "update_record", _update_record)
    monkeypatch.setattr(facade.EDUXApp, "remove_record", _remove_record)
