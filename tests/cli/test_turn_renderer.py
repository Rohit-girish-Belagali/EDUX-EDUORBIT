...
The chat agent loop (edux/agents/chat/agent_loop.py) streams every
...
from edux.app import TurnRequest
from edux_cli import common as cli_common
from edux_cli.common import _resolve_answer
...
def _install_fake_runtime(
    ...
    *,
    ...
    monkeypatch.setattr("edux.app.facade.EDUXApp.submit_user_reply", _submit_user_reply)
