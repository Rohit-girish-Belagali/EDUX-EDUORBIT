...
from edux.agents.chat.agent_loop import InlineThinkFilter
from edux.agents.chat.agentic_pipeline import AgenticChatPipeline
from edux.capabilities.explore_context import explorer as explorer_mod
from edux.capabilities.mastery import MASTERY_TOOL_NAMES
...
from edux.core.tool_protocol import ToolResult
...
def _fake_llm_config(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(
        "edux.agents.chat.agentic_pipeline.get_llm_config",
...
def test_compose_enabled_tools_injects_rag_when_kb_selected(
    ...
    monkeypatch.setattr(
        "edux.services.notebook.get_notebook_manager",
