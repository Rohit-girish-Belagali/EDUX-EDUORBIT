...
from edux.services.llm.provider_core.base import LLMResponse, ToolCallRequest
...
def test_build_openai_client_routes_anthropic_backend_through_adapter(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "edux.services.llm.provider_core.AnthropicProvider",
        FakeProvider,
    )
...
def test_build_openai_client_routes_oauth_backend_through_adapter(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "edux.services.llm.provider_core.OpenAICodexProvider",
        FakeProvider,
    )
...
def test_build_openai_client_routes_github_copilot_backend_through_adapter(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "edux.services.llm.provider_core.GitHubCopilotProvider",
        FakeProvider,
    )
