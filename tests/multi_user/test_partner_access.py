...
from edux.multi_user import partner_access
from edux.multi_user.grants import empty_grant, normalize_grant
...
def _patch_manager(monkeypatch, partners: list[dict]) -> None:
    import edux.services.partners as pkg
...
def test_admin_partner_summary_is_identity_only(monkeypatch):
    from edux.multi_user import router
