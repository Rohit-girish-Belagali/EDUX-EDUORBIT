...
from edux.services.voice import synthesize_speech, transcribe_audio
from edux.services.voice.adapters.openai_compat import (
    OpenAICompatSTTAdapter,
    OpenAICompatTTSAdapter,
    OpenRouterTTSAdapter,
)
from edux.services.voice.base import (
    build_auth_headers,
    join_audio_path,
...
async def test_tts_adapter_raises_on_http_error(monkeypatch: pytest.MonkeyPatch) -> None:
    from edux.services.voice.base import VoiceProviderError
