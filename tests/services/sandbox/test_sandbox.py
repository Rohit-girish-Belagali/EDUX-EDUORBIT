...
from edux.services.sandbox.backends import BwrapBackend, RestrictedSubprocessBackend
from edux.services.sandbox.config import SandboxSettings, build_backend
from edux.services.sandbox.quota import QuotaExceeded, UserExecQuota
from edux.services.sandbox.service import SandboxService
from edux.services.sandbox.spec import ExecRequest, ExecResult, IsolationLevel, ResourceLimits


def test_backend_selection_runner_url() -> None:
    from edux.services.sandbox.backends import RunnerSidecarBackend
...
def test_backend_selection_none_without_optin() -> None:
    ...
    from edux.services.sandbox.backends import RestrictedSubprocessBackend
...
def test_runner_server_validates_request_shape() -> None:
    from edux.services.sandbox.runner import server
