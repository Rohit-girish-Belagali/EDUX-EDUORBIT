...
def _install_stub_parse_service(monkeypatch, results: dict[str, "object"]) -> None:
    ...
    """
    import edux.services.parsing as parsing
...
def test_loader_routes_parser_files_through_active_parse_engine(
    ...
    from edux.services.rag.pipelines.llamaindex.document_loader import (
...
def test_loader_indexes_images_extracted_from_parsed_document(
    ...
    from edux.services.parsing.types import ParsedDocument
    from edux.services.rag.pipelines.llamaindex import document_loader as loader_module
