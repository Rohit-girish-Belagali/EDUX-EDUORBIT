...
async def run_test(
    *,
    ...
    from edux.services.llm import config as config_module
    from edux.services.llm.config import LLMConfig, get_llm_config
    ...
    try:
        from edux.services.llm.factory import complete

        t0 = time.perf_counter()
        resp = await complete(
            "Reply with exactly: HELLO_EDUX",
    ...
    if test_stream:
        ...
        try:
            from edux.services.llm.factory import stream
