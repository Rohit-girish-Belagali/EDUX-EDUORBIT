...
from edux.multi_user.paths import get_admin_path_service, user_context
from edux.partners.config.paths import get_partner_sessions_dir, get_partner_workspace
...
def _fresh_memory_singleton(monkeypatch):
    ...
    from edux.services.memory import store
