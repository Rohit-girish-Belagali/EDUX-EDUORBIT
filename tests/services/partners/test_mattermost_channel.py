...
from edux.partners.channels import mattermost as mm_module
from edux.partners.channels.mattermost import MattermostChannel, MattermostConfig
...
def _ok_http() -> AsyncMock:
    ...
    resp.json = MagicMock(return_value={"file_infos": [{"id": "file-edux"}]})
