...
from edux.services.generation_http import (
    GenerationProviderError,
    build_auth_headers,
    join_api_path,
)
from edux.services.imagegen import generate_image
from edux.services.imagegen.adapters.chat_completions import ChatCompletionsImagegenAdapter
from edux.services.imagegen.adapters.openai_compat import OpenAICompatImagegenAdapter
from edux.services.imagegen.config import ImagegenConfig
from edux.services.videogen import generate_video, probe_video
from edux.services.videogen.adapters.async_task import AsyncTaskVideogenAdapter
from edux.services.videogen.config import VideogenConfig
...
async def test_imagegen_tool_saves_public_artifact(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import edux.services.imagegen as imagegen_mod
    from edux.services.path_service import get_path_service
    from edux.tools.media_gen_tool import ImagegenTool
...
async def test_videogen_tool_forwards_progress_and_saves(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from edux.services.path_service import get_path_service
    import edux.services.videogen as videogen_mod
    from edux.tools.media_gen_tool import VideogenTool
