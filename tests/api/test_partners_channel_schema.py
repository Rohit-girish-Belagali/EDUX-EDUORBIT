...
from edux.api.routers._partners_channel_schema import (
    all_channel_schemas,
...
class TestChannelSchemaPayload:
    def test_telegram_payload_shape(self) -> None:
        from edux.partners.channels.telegram import TelegramChannel
    ...
    def test_slack_dm_subtree_inlined(self) -> None:
        from edux.partners.channels.slack import SlackChannel
...
class TestEndpoint:
    ...
    def client(self) -> TestClient:
        ...
        from edux.api.routers import partners as partners_router
