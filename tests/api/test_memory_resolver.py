...
memory_router = importlib.import_module("edux.api.routers.memory").router
paths_mod = importlib.import_module("edux.services.memory.paths")
document_mod = importlib.import_module("edux.services.memory.document")
