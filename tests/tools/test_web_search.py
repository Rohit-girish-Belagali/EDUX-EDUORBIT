...
from edux.services.search import _assert_provider_supported
from edux.services.search.providers import (
    _DEPRECATED_UNSUPPORTED,
    get_provider,
    get_providers_info,
    list_providers,
)
from edux.services.search.types import Citation, SearchResult, WebSearchResponse
...
class TestProviderRegistry:
    ...
    def test_get_provider_raises_on_unknown(self) -> None:
        with pytest.raises(ValueError, match="Unknown provider"):
            get_provider("nonexistent_provider_edux")
