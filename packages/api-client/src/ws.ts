/**
 * Unified WebSocket Client — works on both web and React Native.
 * React Native ships a global WebSocket that is API-compatible with the
 * browser's, so this file needs zero platform-specific changes.
 */
