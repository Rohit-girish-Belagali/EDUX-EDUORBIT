...
from edux.core.capability_protocol import BaseCapability
from edux.i18n.metadata_i18n import capability_description_i18n
...
def _load_plugin_hooks():
    try:
        module = importlib.import_module("edux.plugins.loader")
    except Exception:
