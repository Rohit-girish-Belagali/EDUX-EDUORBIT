"""Runtime home resolution for installed and source EDUX runs."""
...
def get_runtime_home(home: str | Path | None = None) -> Path:
    ...
    2. ``EDUX_HOME`` environment variable.
    ...
    raw = home if home is not None else os.getenv(EDUX_HOME_ENV)
