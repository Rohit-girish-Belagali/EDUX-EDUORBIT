...
from edux.api.routers.mastery_path import router
...
def app(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "edux.api.routers.mastery_path.LearningStore",
...
class TestGenerateFromNotebook:
    ...
    @patch("edux.services.llm.complete", new_callable=AsyncMock)
    ...
    @patch("edux.api.routers.mastery_path.get_ui_language", return_value="en")
    @patch("edux.services.llm.complete", new_callable=AsyncMock)
    ...
    @patch("edux.api.routers.mastery_path.get_ui_language", return_value="zh")
    @patch("edux.services.llm.complete", new_callable=AsyncMock)
