...
vault (resolved by :mod:`edux.capabilities.obsidian.binding`). As a
...
from edux.capabilities.obsidian.binding import vault_for_turn
from edux.capabilities.obsidian.tools import OBSIDIAN_TOOL_NAMES
