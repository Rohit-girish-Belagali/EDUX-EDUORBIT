...
:class:`~edux.capabilities.obsidian.capability.ObsidianCapability`, which
...
:mod:`edux.capabilities.obsidian.vault` operations.
...
from edux.capabilities.obsidian import vault as vault_ops
