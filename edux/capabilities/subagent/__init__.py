...
through :mod:`edux.services.subagent` and streaming its native run to the
...
from edux.capabilities.subagent.capability import SubagentCapability
from edux.capabilities.subagent.tools import (
    SUBAGENT_TOOL_NAMES,
    SUBAGENT_TOOL_TYPES,
    ConsultSubagentTool,
)
