...
:mod:`edux.capabilities` (``solve``, ``mastery``). The chat loop imports
...
from edux.capabilities.protocol import KnowledgeCapability, LoopCapability, PromptBlock
from edux.capabilities.registry import (
    LOOP_CAPABILITIES,
