...
from edux.services.rag.provider_binding import resolve_bound_provider
...
class DocumentAdder:
    ...
    def __init__(
        ...
        # Incremental adds must use the engine EDUX has bound to this KB. An
        ...
        for idx, doc_file in enumerate(new_files, 1):
            try:
                if self.progress_tracker is not None:
                    from edux.knowledge.progress_tracker import ProgressStage
