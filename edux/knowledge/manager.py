...
from edux.knowledge.kb_types import (
...
from edux.services.rag.index_probe import (
    inspect_kb_versions,
...
class KnowledgeBaseManager:
    ...
    def update_kb_status(
        ...
        if status == "ready":
            ...
            try:
                from edux.services.rag.embedding_signature import (
    ...
    def list_knowledge_bases(self) -> list[str]:
        ...
        if base_exists:
            for item in self.base_dir.iterdir():
                ...
                from edux.services.rag.index_versioning import list_kb_versions
