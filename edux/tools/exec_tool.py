...
runs through the :mod:`edux.services.sandbox` layer rather than a raw
...
# NOTE: ``edux.services.sandbox`` is imported lazily inside ``execute``
# (not at module top). This tool is loaded by ``edux.tools.builtin``,
