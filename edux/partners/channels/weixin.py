...
from edux.partners.config.paths import get_media_dir, get_runtime_subdir
from edux.partners.config.schema import DeliveryOverrides
from edux.partners.helpers import safe_filename, split_message
...
class WeixinChannel(BaseChannel):
    ...
    async def _send_text(
        ...
        client_id = f"edux-{uuid.uuid4().hex[:12]}"
