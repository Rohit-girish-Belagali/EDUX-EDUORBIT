...
class EDUXError(Exception):
    """Base class for all application errors in EDUX."""
...
class ConfigurationError(EDUXError):
    """Raised when there's a configuration-related error."""

    pass


class ValidationError(EDUXError):
    """Raised when input validation fails."""

    pass


class ServiceError(EDUXError):
