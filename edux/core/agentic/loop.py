...
:func:`~edux.core.agentic.labeled_step.run_labeled_step` call, after
which the loop:
...
from edux.core.agentic.labeled_step import LabeledStepResult, run_labeled_step
from edux.core.agentic.labels import LABEL_UNKNOWN, find_inline_labels
