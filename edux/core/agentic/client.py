...
from edux.services.config import load_system_settings
from edux.services.llm import get_token_limit_kwargs, supports_tools
from edux.services.llm.reasoning_params import (
    build_openai_compatible_reasoning_kwargs,
)
from edux.services.provider_registry import find_by_name
...
def _build_native_provider_adapter(config: LLMClientConfig, spec: Any) -> Any | None:
    if spec.backend == "anthropic":
        from edux.services.llm.provider_core import AnthropicProvider
    ...
    if spec.backend == "openai_codex":
        from edux.services.llm.provider_core import OpenAICodexProvider
    ...
    if spec.backend == "github_copilot":
        from edux.services.llm.provider_core import GitHubCopilotProvider
