...
class UsageTracker:
    ...
    * :meth:`add_estimated` — fall back to a coarse ``chars / 3.5`` estimate
    ...
    ``total_cost_usd`` via the pricing table in ``edux.logging.stats``.
    """
    ...
    def add_usage(
        ...
        *,
        ...
        """Adapter for :class:`~edux.agents.base_agent.BaseAgent`.
    ...
    def summary(self) -> dict[str, Any] | None:
        ...
        if self.model:
            ...
            from edux.logging.stats.llm_stats import get_pricing
