...
from edux.core.i18n import current_language
from edux.i18n.metadata_i18n import localized_description, tool_description_i18n
...
async def build_tool_options(
    *, exclude_builtin: set[str] | None = None
    ...
    from edux.tools.builtin import CONFIGURABLE_BUILTIN_TOOL_NAMES
    ...
    try:
        from edux.services.mcp import get_mcp_manager
