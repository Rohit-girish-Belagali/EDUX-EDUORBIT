...
from edux.learning import policy as learning_policy
from edux.learning import prompts as learning_prompts
...
async def _cancel_active_learning_turn(book_id: str) -> None:
    from edux.services.session import get_turn_runtime_manager
