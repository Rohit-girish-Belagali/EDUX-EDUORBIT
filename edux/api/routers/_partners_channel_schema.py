...
Why live here vs inside ``edux.partners.channels``?
...
from edux.services.partners.manager import _is_secret_field
...
def all_channel_schemas() -> dict[str, dict[str, Any]]:
    ...
    """
    from edux.partners.channels.registry import discover_all_with_errors
