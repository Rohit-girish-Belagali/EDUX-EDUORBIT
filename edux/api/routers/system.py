...
from edux.services.config import resolve_search_runtime_config
...
from edux.services.llm import get_llm_config, get_token_limit_kwargs
...
async def test_search_connection():
    ...
    try:
        ...
        result = web_search("EDUX health check", provider=search_config.provider)
        response_time = (time.time() - start_time) * 1000
