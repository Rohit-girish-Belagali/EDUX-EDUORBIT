...
from edux.core.agentic.usage import UsageTracker
from edux.core.capability_protocol import BaseCapability, CapabilityManifest
from edux.core.context import UnifiedContext
from edux.core.stream_bus import StreamBus
from edux.core.trace import merge_trace_metadata
from edux.i18n import StatusI18n
from edux.runtime.request_contracts import get_capability_request_schema
...
class DeepQuestionCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        ...
        if isinstance(followup_question_context, dict) and followup_question_context.get(
            ...
            from edux.agents.question.agents.followup_agent import FollowupAgent
        ...
        if mode != "mimic":
            ...
            from edux.agents.question.history import load_session_quiz_history
            from edux.agents.question.pipeline import QuestionPipeline
            from edux.agents.question.request_config import (
                build_question_runtime_config,
            )
            from edux.services.config import load_config_with_main
    ...
    async def _run_mimic_mode(
        ...
        * ``[Attached Documents]`` in  → no paper available; fall back to
        ...
        """
        from edux.agents.question.history import load_session_quiz_history
        from edux.agents.question.mimic_source import (
        ...
        from edux.services.config import load_config_with_main
        from edux.services.parsing.engines.mineru.config import MinerUError
