...
to :mod:`edux.core.agentic` and the shared tool-composition policy.
"""
...
from edux.agents._shared.capability_result import emit_capability_result
...
from edux.core.agentic.labels import find_inline_labels
...
from edux.services.config import parse_language
from edux.services.llm import get_llm_config, prepare_multimodal_messages
from edux.services.path_service import get_path_service
from edux.services.prompt import get_prompt_manager
from edux.services.prompt.language import append_language_directive
from edux.services.sandbox import exec_capability_available
    ...
    async def _summarize_tool_result(
        ...
        *,
        ...
        meta = build_trace_metadata(
            ...
            label=self._t("labels.reflecting", default="EDUX Reflecting..."),
        ...
        await stream.progress(
            self._t("labels.reflecting", default="EDUX Reflecting..."),
            source=SOURCE,
            stage=STAGE_EXPLORING,
