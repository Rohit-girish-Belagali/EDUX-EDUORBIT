...
from edux.agents.research.data_structures import (
    DynamicTopicQueue,
    ToolTrace,
    TopicBlock,
    TopicStatus,
)
from edux.agents.research.utils.citation_manager import CitationManager
...
from edux.core.agentic.tool_dispatch import (
...
class ResearchPipeline:
    ...
    LLM call goes through :mod:`edux.core.agentic` primitives. The
...
class _RephraseLoopHost:
    ...
    async def resolve_pause(self, dispatch: DispatchOutcome) -> bool:
        from edux.agents.chat.agentic_pipeline import (
