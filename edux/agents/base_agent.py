...
from edux.config.settings import settings
from edux.logging import LLMStats
from edux.services.config import get_agent_params
...
class BaseAgent(ABC):
    ...
    def __init__(
        ...
        self.logger = logging.getLogger(f"edux.{logger_name}")
