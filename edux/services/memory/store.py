...
from edux.services.memory import consolidator, paths, trace
from edux.services.memory.consolidator import ConsolidateResult, OnEvent
from edux.services.memory.document import Document, parse, serialize
from edux.services.memory.ops import AddOp, ApplyReport, EditOp
from edux.services.memory.ops import apply as ops_apply
...
_NO_MEMORY = (
    "(No memory available — interact with EDUX and update from the Memory page to build one.)"
)
...
class MemoryStore:
    ...
    async def apply_ops_payload(
        ...
        """
        from edux.services.memory.consolidator import _parse_ops_response
