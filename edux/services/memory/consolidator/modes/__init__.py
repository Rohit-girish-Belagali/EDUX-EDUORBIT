...
for :mod:`edux.services.memory.store` so the public API surface
stays stable while the implementation switches under the hood.
"""

from __future__ import annotations

from edux.services.memory.consolidator.modes._shims import (
    consolidate_l2,
    consolidate_l3,
)
from edux.services.memory.consolidator.modes.audit import run_audit
...
from edux.services.memory.consolidator.modes.update import run_update
