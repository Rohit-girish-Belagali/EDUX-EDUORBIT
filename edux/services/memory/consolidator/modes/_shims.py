"""Legacy public-API shims for :mod:`edux.services.memory.store`.
...
from edux.services.memory.consolidator.modes.update import (
    UpdateResult,
    run_update,
)
from edux.services.memory.document import parse, serialize
from edux.services.memory.ops import ApplyReport, Op
