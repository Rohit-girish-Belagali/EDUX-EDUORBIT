...
* :class:`ConsolidateResult`, :data:`OnEvent` — legacy types preserved
  for :mod:`edux.services.memory.store`.
...
from edux.services.memory.consolidator.guards import _filter_banned, _has_banned
from edux.services.memory.consolidator.modes import (
    consolidate_l2,
    consolidate_l3,
    run_audit,
    run_dedup,
...
from edux.services.memory.consolidator.parse import _parse_ops_response
