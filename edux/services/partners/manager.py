...
Each partner runs as a set of asyncio tasks within the EDUX server
...
class PartnerManager:
    ...
    async def _outbound_router(self, partner_id: str, bus: Any, instance: PartnerInstance) -> None:
        ...
        try:
            from edux.events.event_bus import Event, EventType, get_event_bus
            from edux.partners.bus.events import OutboundMessage as _OMsg
