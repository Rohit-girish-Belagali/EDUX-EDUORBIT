...
class PartnerRunner:
    ...
    def _build_context(self, msg: InboundMessage) -> UnifiedContext:
        ...
        metadata: dict[str, Any] = {
            ...
            # Swaps the system prompt's product identity ("You are EDUX")
