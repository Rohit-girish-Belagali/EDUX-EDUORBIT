...
from edux.services.partners.scope import partner_scope
...
def _copy_knowledge_base(kb_ref: str, partner_root: Path) -> str:
    from edux.multi_user.knowledge_access import resolve_kb
...
def _skill_source_dir(skill_name: str) -> Path:
    ...
    """
    from edux.multi_user.context import get_current_user
    from edux.services.skill.service import BUILTIN_SKILLS_ROOT
