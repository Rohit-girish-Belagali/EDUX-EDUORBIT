...
EDUX runs on the same machine as the user's configured Claude Code / Codex,
...
from edux.services.subagent.partner import PARTNER_BACKEND_KIND
from edux.services.subagent.registry import detect_all, get_backend, list_backend_kinds
