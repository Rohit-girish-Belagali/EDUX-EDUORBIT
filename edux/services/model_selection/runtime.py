...
from edux.services.config.provider_runtime import ResolvedLLMConfig, resolve_llm_runtime_config
from edux.services.config.user_llm_override import apply_user_key_override
...
def activate_llm_selection(selection: Any) -> tuple[LLMConfig, Token[LLMConfig | None]]:
    ...
    config = apply_user_key_override(config)
