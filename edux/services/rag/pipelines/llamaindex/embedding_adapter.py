"""LlamaIndex embedding adapter backed by EDUX's embedding service."""
...
from edux.services.embedding import EmbeddingConfig, get_embedding_client, get_embedding_config
from edux.services.embedding.validation import validate_embedding_batch
...
class CustomEmbedding(BaseEmbedding):
    """Custom LlamaIndex embedding adapter for EDUX embedding providers."""
...
def configure_llamaindex_settings(logger=None) -> None:
    """Configure LlamaIndex globals for EDUX's current embedding config."""
