...
deleting the KB only drops EDUX's pointer (handled by the manager) and must
...
from edux.services.rag.provider_binding import load_kb_config_entry
...
class LightRagServerPipeline:
    ...
    async def initialize(self, kb_name: str, file_paths: List[str], **kwargs) -> bool:
        raise RuntimeError(
            ...
            "EDUX does not build or store their index. Add documents on the "
