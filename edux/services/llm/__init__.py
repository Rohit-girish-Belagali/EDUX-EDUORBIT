...
Unified LLM service for all EDUX modules.
...
Usage:
    ...
    from edux.services.llm import complete, stream
    ...
    # Configuration
    from edux.services.llm import get_llm_config, LLMConfig
    config = get_llm_config()

    # URL utilities for local LLM servers
    from edux.services.llm import sanitize_url, is_local_llm_server
"""
...
def __getattr__(name: str):
    ...
    if name == "cloud_provider":
        return import_module("edux.services.llm.cloud_provider")
    if name == "local_provider":
        return import_module("edux.services.llm.local_provider")
