...
from edux.services.llm.capabilities import disable_response_format_at_runtime
from edux.services.llm.openai_http_client import openai_client_kwargs
from edux.services.llm.provider_core.base import LLMProvider, LLMResponse, ToolCallRequest
from edux.services.llm.provider_core.openai_responses import (
...
from edux.services.llm.reasoning_params import (
    build_openai_compatible_reasoning_kwargs,
)

if TYPE_CHECKING:
    from edux.services.provider_registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/eduorbit/EDUX",
    "X-OpenRouter-Title": "EDUX",
}
