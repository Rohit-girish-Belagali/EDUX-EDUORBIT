...
stage. An engine turns bytes/path into a :class:`~edux.services.parsing.types.ParsedDocument`
...
class Parser(Protocol):
    ...
    def parse(
        ...
        *,
        ...
        workdir via :func:`edux.services.parsing.cache.load_ir` and writes
