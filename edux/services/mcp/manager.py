...
EDUX's chat runs as per-turn tasks inside one event loop, while MCP
...
from edux.core.tool_protocol import BaseTool, ToolDefinition, ToolResult
from edux.services.mcp.config import (
    MCPConfig,
    MCPServerConfig,
    load_mcp_config,
)
